...
const dummyMeals = [
  ...
  Meal(
    ...
    complexity: Complexity.challenging,
    imageUrl:
        'https://www.indianhealthyrecipes.com/wp-content/uploads/2022/06/chicken-tikka-masala-recipe.jpg',
    duration: 35,
    ingredients: [
      '4 Chicken Breasts',
      '1 Onion',
  ...
  Meal(
    ...
    affordability: Affordability.affordable,
    complexity: Complexity.simple,
    imageUrl: 'https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSq8AxyGuMF7CCKl9UaBMeOcwZr4DuL42vZhPSNln4tMiezJe9wRJIlYBDrZMiD5-8wFmmHzAcZMuqlMg-_g7UoKhkK5uYd2N_ufr3p1Q',
    duration: 25,
    ingredients: [
      '2 Cups Wheat Flour',
      '1/2 Teaspoon Salt',
  ...
  Meal(
    ...
    steps: [
      ...
      'Place vegetables and protein in the center of the wrapper.',
  ...
  Meal(
    ...
    steps: [
      ...
      'Combine with pasta and top with cheese if desired.'
    ],
    isGlutenFree: false,
    isVegan: false,
    isVegetarian: true,
